...
const App = () => {
   ...
   return (
      <div className="bg-[#101010] text-[#F4F4F4] flex flex-col min-h-screen overflow-x-hidden">
         <SEO 
            description="Zoom Dispatch - Fast, reliable, and secure logistics solutions for your business and personal needs."
            keywords="logistics, dispatch, delivery, business delivery, bike delivery"
         />
         <Header />
         <div className="grow">
