...
const About = () => {
   return (
      <div className="flex flex-col">
         <SEO 
            title="About Us"
            description="Learn more about Zoom Dispatch, our mission to deliver excellence, and our CEO Joshua Okibe."
            keywords="zoom dispatch about, logistics mission, delivery excellence, joshua okibe"
         />
