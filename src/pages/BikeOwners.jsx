...
const BikeOwners = () => {
   ...
   return (
      <div className="w-full">
         <SEO 
            title="Bike Owners & Riders"
            description="Got a bike or already a rider? Join Zoom Dispatch and start earning on your own terms today."
            keywords="bike delivery jobs, rider partnership, earn with bike, logistics rider"
         />
         <div 
