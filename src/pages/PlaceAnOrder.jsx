   ...
   return (
      <div className="min-h-screen w-full pt-32 mb-24 px-6 md:px-10 relative">
         <SEO 
            ...
            description="Experience a zoom dispatch. Order from your favorite brands and get them delivered swiftly."
            keywords="order online, food delivery, zoom dispatch order, local brands delivery"
         />
