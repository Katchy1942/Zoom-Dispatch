         ...
         <div className="relative z-10 flex w-full gap-6 items-center">
            <div className="w-full md:w-1/2 flex flex-col">
               ...
               <div className="flex flex-col gap-1">
                  <a target='_blank' rel='noopener noreferrer' href="https://wa.me/2349052452642" className="bg-[#FF0000] w-fit text-[#101010] px-6 py-2.5 text-base font-bold cursor-pointer rounded-full hover:bg-[#FF0000]/90 transition-colors">Let's help you deliver</a>
